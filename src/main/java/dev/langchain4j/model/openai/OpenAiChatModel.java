...
public class OpenAiChatModel implements ChatModel {
    ...
    public OpenAiChatModel(OpenAiChatModelBuilder builder) {
        ...
        this.sendThinking = getOrDefault(builder.sendThinking, this.returnThinking);
    ...
    private static Message toOpenAiMessage(ChatMessage message, boolean sendThinking, String thinkingFieldName) {
        if (message instanceof AiMessage aiMessage && aiMessage.hasToolExecutionRequests()) {
            return toOpenAiAssistantWithToolReasoning(aiMessage, thinkingFieldName);
        }
        return OpenAiUtils.toOpenAiMessage(message, sendThinking, thinkingFieldName);
    }
